...
export const zhCN = {
  ...
  communityAdmin: {
    ...
    reviewFailed: '审核失败',
    rules: { saveFailed: '保存失败', harm: '明确伤害', harassment: '骚扰', sexual: '色情', spam: '垃圾推广', current: '当前', history: '历史' },
    tags: { created: '标签已创建。', createFailed: '创建失败', updated: '标签已更新。', updateFailed: '更新失败', merged: '标签已合并，旧标签保留指向。', mergeFailed: '合并失败', mergedState: '已合并', enabled: '启用', disabled: '停用', renamePrompt: '输入新名称', mergePrompt: '输入目标标签 ID' },
    users: { loadFailed: '加载失败', updated: '账号状态已更新，目标账号会话已全部撤销。', updateFailed: '更新失败', anonymized: '已注销用户', unverified: ' · 未验证', promote: '设为版主', demote: '降为用户', restore: '恢复', suspend: '暂停' },
    analytics: { withdrawn: '已撤回同意并清除该访客的原始事件和身份关联。', saved: '偏好已保存。', saveFailed: '偏好保存失败，请稍后重试。', granted: '已同意', denied: '已拒绝', unset: '尚未选择', loading: '正在读取偏好…' },
    interaction: { actionFailed: '操作失败，请稍后重试', genericFailed: '操作失败', reuseFailed: '引用失败', pending: '评论已提交，审核通过后公开。', published: '评论已发布。', commentFailed: '评论失败', reported: '举报已进入治理队列。', reportFailed: '举报失败', editPending: '修改已进入审核。', updated: '评论已更新。', editFailed: '修改失败', deleted: '评论已删除。', deleteFailed: '删除失败', commentReported: '评论举报已进入治理队列。', locked: '评论已锁定', commentPlaceholder: '最多 500 字；链接仅作为纯文本展示' },
    mine: { withdrawing: '撤回中…', withdraw: '撤回作品' },
    submission: { createFailed: '创建投稿失败', submitFailedDraftKept: '提交审核失败，草稿已保留', failed: '提交失败', submitting: '提交中…', submit: '冻结快照并提交审核' },
    home: { featured: '人工精选', latest: '豆社新作', featuredProofs: '本期作品校样', latestProofs: '最近公开作品' },
  },
  about: {
    title: '关于豆谱',
    intro:
