    ...
    <main id="main" className="workspace-page">
      ...
      <div className="workspace-content info-page-content">
        ...
        <div className="about-card-grid">
          <section className="info-card"><span><Icon name="lock" /></span><h2>{t.privacyTitle}</h2><p>{t.privacyBody}</p><Link href="/privacy" className="link-soft">{t.privacyLink}</Link></section>
