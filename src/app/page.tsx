  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-center gap-10 px-6 text-center">
      ...
      <section className="flex w-full max-w-md flex-col gap-3">
        <div className="rounded-lg border-2 border-dashed border-gray-300 p-8 text-gray-500">
          {home.uploadHint}
        </div>
        <ol className="flex flex-col items-start gap-2 text-left text-sm text-gray-600">
          <li>1. {home.guideStep1}</li>
          <li>2. {home.guideStep2}</li>
          <li>3. {home.guideStep3}</li>
        </ol>
      </section>

      <nav className="flex gap-6 text-sm text-blue-600 underline-offset-4 hover:underline">
